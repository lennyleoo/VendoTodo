...
const App = () => {
  const [products] = useState([
      ...
      { id: 4, images: ['botines 43 negro rojo.png','botines_43_negros_rojo-removebg-preview (1).png'], title: 'Botines Adidas Predator Talle 43', description: 'Futsal - Muy poco uso.', price: 70000, category: 'deportes'},
